# Modules to extract sidechains torsions from
# Copyright (c) 2014 Lenna X. Peterson, all rights reserved
# lenna@purdue.edu
# Modified by oz, Jun 1, 2022
...
class GetTorsion(object):
    ...
    def __init__(self):
        ...
        self.default_chi = [1]
        self.default_outfile = "torsion_list.csv"

    def read_torsions(self, input, outfile=None, chi=None, units=None, verbose=False):
        # Configure chi
        if chi is None:
