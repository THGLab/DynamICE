...
import numpy as np
from sidechainnet.build_info import NUM_COORDS_PER_RES, SC_BUILD_INFO
from sidechainnet.HydrogenBuilder import NUM_COORDS_PER_RES_W_HYDROGENS
from sidechainnet.sequence import ONE_TO_THREE_LETTER_MAP, ATOM_MAP_14, ATOM_MAP_24
