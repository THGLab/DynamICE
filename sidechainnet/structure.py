'''
contains high-level functionality for protein structure building tools
'''
...
from sidechainnet.build_info import NUM_ANGLES
from sidechainnet.sequence import GLOBAL_PAD_CHAR, VOCAB
