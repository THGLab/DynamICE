...
from dynamice.models.dense import Dense
...
class MLP(nn.Module):
    ...
    def __init__(
        self, n_in, n_out, n_hidden=None, n_layers=2, activation=nn.ReLU(),
            out_activation=None, dropout=None
    ):
        ...
        layers = [
            Dense(self.n_neurons[i], self.n_neurons[i + 1], activation=activation, dropout=dropout)
